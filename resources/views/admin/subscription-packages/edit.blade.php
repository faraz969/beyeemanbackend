<x-admin-layout header="Edit Subscription Package">
    <div class="space-y-6">
        <!-- Back Button -->
        <div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-6">Edit Subscription Package</h3>
            ...
            <form method="POST" action="{{ route('admin.subscription-packages.update', $package->id) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="duration_type" 
                            ...
                            <option value="month" {{ old('duration_type', $package->duration_type) === 'month' ? 'selected' : '' }}>Month</option>
                            <option value="months" {{ old('duration_type', $package->duration_type) === 'months' ? 'selected' : '' }}>Months</option>
                            <option value="year" {{ old('duration_type', $package->duration_type) === 'year' ? 'selected' : '' }}>Year</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               id="max_products"
                               min="0"
                               value="{{ old('max_products', $package->max_products) }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               min="0"
                               value="{{ old('featured_listing_count', $package->featured_listing_count) }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="features" 
                              id="features"
                              rows="5"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('features', $package->features) }}</textarea>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="featured_listing"
                               value="1"
                               {{ old('featured_listing', $package->featured_listing) ? 'checked' : '' }}
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('priority_visibility', $package->priority_visibility) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="free_promotions"
                               value="1"
                               {{ old('free_promotions', $package->free_promotions) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               value="1"
                               {{ old('dashboard_analytics', $package->dashboard_analytics) ? 'checked' : '' }}
                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
