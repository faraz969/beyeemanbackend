<x-admin-layout header="Edit Featured Banner">
    <div class="space-y-6">
        <!-- Back Button -->
        <div>
        ...
        <div class="bg-white rounded-lg shadow p-6 max-w-4xl">
            <h3 class="text-lg font-semibold text-gray-900 mb-6">Edit Featured Banner</h3>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ $banner->image ? 'Change Banner Image' : 'Banner Image' }}
                        </label>
                        <input type="file" 
                               name="image" 
                               id="image" 
                    ...
                    <div>
                        ...
                        <select name="link_type" 
                            ...
                            <option value="vendor" {{ old('link_type', $banner->link_type) === 'vendor' ? 'selected' : '' }}>Link to Shop/Vendor</option>
                    ...
                    <div id="external_url_field" style="display: none;">
                        ...
                        <input type="url" 
                               name="external_url" 
                               id="external_url" 
                               value="{{ old('external_url', $banner->external_url) }}"
        ...
        function toggleLinkFields() {
            ...
            if (linkType === 'product') {
                ...
                products.forEach(product => {
                    ...
                    if (product.id == {{ old('link_id', $banner->link_id ?? 0) }}) {
                ...
                shops.forEach(shop => {
                    ...
                    if (shop.id == {{ old('link_id', $banner->link_id ?? 0) }}) {
                        option.selected = true;
                    }
                    linkIdSelect.appendChild(option);
                });
                ...
                categories.forEach(category => {
                    ...
                    if (category.id == {{ old('link_id', $banner->link_id ?? 0) }}) {
                        option.selected = true;
                    }
                    linkIdSelect.appendChild(option);
                });
